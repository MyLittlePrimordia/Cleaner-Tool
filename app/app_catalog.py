...
MANUAL_ONLY_APPS = [
    ...
    {"id": 'manual:shadps4', 'name': 'ShadPS4', 'category': 'Gaming Tools & Emulators',
     'description': 'PS4 emulator - official build (no winget package)',
     'foss': True, 'url': 'https://github.com/shadps4-emu/shadPS4/releases/latest'},
...
APP_CATALOG = [
    ...
    {"id": 'LibreWolf.LibreWolf', "name": 'LibreWolf', "category": 'Web Browsers',
     "description": 'Privacy-hardened Firefox fork with telemetry stripped and uBlock Origin built in', "foss": True,
    ...
    {"id": 'shinchiro.mpv', "name": 'mpv', "category": 'Media, Streaming & Audio',
     "description": 'FOSS lightweight, high-quality video player for local files and streams', "foss": True,
     "url": 'https://mpv.io/'},
    ...
    {"id": 'Streamlabs.Streamlabs', "name": 'Streamlabs', "category": 'Media, Streaming & Audio',
     "description": 'All-in-one streaming software with alerts, widgets and overlays', "foss": False,
    ...
    {"id": 'RevoUninstaller.RevoUninstaller', "name": 'Revo Uninstaller', "category": 'Utilities & Cleaners',
     "description": 'Uninstaller that hunts leftover files and registry keys after the stock uninstaller finishes (free edition)', "foss": False,
    ...
    {"id": 'WinDirStat.WinDirStat', "name": 'WinDirStat', "category": 'Utilities & Cleaners',
     "description": 'Classic FOSS disk usage treemap visualizer', "foss": True,
    ...
    {"id": 'Wagnardsoft.ISLC', "name": 'Intelligent Standby List Cleaner (ISLC)', "category": 'Hardware Diagnostics & Tuning',
     "description": 'Clears the Windows standby memory list to reduce stutter, popular in gaming communities', "foss": False,
     "url": 'https://www.wagnardsoft.com/ISLC'},
    {"id": 'Henry++.MemReduct', "name": 'Mem Reduct', "category": 'Hardware Diagnostics & Tuning',
     "description": 'Tiny free RAM cleaner many gamers run before a session', "foss": True,
    ...
    {"id": 'OCBase.OCCT.Personal', "name": 'OCCT', "category": 'Hardware Diagnostics & Tuning',
     "description": 'CPU/GPU/RAM stability and thermal stress testing (free Personal edition)', "foss": False,
