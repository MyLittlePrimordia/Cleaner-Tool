...
PRESETS = {
    ...
    "Tweak": {
        ...
        "Recommended": [
            ...
            # C7: explorer_auto_discovery deliberately NOT here — it
            # irreversibly wipes all saved folder views (no backup/Undo).
            # Still available in Custom.
            "fullscreen_opt", "ad_blocker",
    ...
    "Clean": [
        ("Game files & caches",
         ["shader_cache", "launcher_cache", "engine_cache", "driver_junk",
          ...
          "vrchat_cache", "fivem_cache", "starcitizen_cache",
          "riot_logs", "hoyoverse_logs", "rockstar_logs", "roblox_logs"]),
        ("Saves safety net",
         ["backup_saves"]),
        ("Windows temp & system junk",
         ["user_temp_files", "system_temp_files", "temp_deep_clean",
           ...
           "gpu_watchdog_dumps", "prefetch", "event_logs", "defender_history"]),
        ...
        ("App, browser & Store caches",
         ["inet_cache", "browser_cache", "office_cache", "uwp_cache",
          ...
          "stream_logs", "squirrel_staging", "setup_logs",
          "edge_update_cache"]),
        ("Uninstalled program leftovers",
         ["orphan_leftovers"]),
        ("Privacy traces",
        ...
        ("Network & firewall",
         ...
         ("Apps, Xbox, devices & drivers",
          ["xbox_apps", "store_apps_reregister", "search_index",
           ...
           "tray_icons", "driver_export", "micfix_audit", "nvidia_app_fix",
           "gameinput_restart", "xboxlive_restart"]),
    ],
    "Tweak": [
        ("Safety net",
         ["restore_point_tweak"]),
        ("Gaming & CPU/GPU performance",
         ["ultimate_performance", "max_cpu_power", "max_performance_gpu",
          ...
          "refresh_rate_fix", "tdr_delay"]),
        ("Network & online ping",
         ["disable_nagle", "network_throttling", "gaming_dns",
          "tweak_delivery_optimization", "eee_disable", "prefer_ipv4"]),
         ("SSD & drive behavior",
          ["ssd_trim", "ssd_superfetch", "ssd_last_access", "ssd_prefetch",
           "disk_timeout", "adv_hibernation", "ntfs_8dot3", "storage_sense",
           "reserved_storage_off", "long_paths"]),
         ("Privacy, telemetry & ads",
          ["privacy_baseline", "stop_telemetry", "limit_telemetry",
           ...
           "clipboard_sync_off", "mic_privacy_allow", "ads_master_off"]),
         ("Windows look, search & startup",
           ["classic_context_menu", "taskbar_cleanup", "local_search",
            "visual_effects", "explorer_auto_discovery",
            "startup_delay", "disable_fast_startup", "file_extensions",
           "menu_delay", "aero_shake", "lock_screen", "edge_preload",
           "dark_mode", "verbose_boot", "widgets_board_off",
           "snap_flyout_off", "taskbar_endtask", "clock_seconds",
           "taskbar_left", "taskbar_never_combine",
           "device_search_history_off", "classic_shortcut_icons",
           "hide_recent"]),
         ("Input, USB & interruptions",
          ["mouse_accel", "keyboard_tuning", "usb_suspend",
           "disable_sticky_keys", "suppress_crash_popups",
           "no_update_reboot", "autoplay_off", "fast_app_close",
           "instant_alt_tab", "numlock_boot", "alt_tab_windows_only",
           "discord_no_ducking"]),
